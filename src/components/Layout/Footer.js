    ...
    <>
          ...
          <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:px-20">
            <div class="p-4 text-left">
              ...
              <ul class="list-none footer-links text-gray-500">
                ...
                <Link to="/safety-security" onClick={() => window.scroll(0, 0)}>
                  <li class="mb-2 hover:text-blue-600 hover:underline">Safety & Security</li>
                </Link>
              </ul>
            </div>
            <div class="p-4 text-left">
            ...
            <div class="p-4">
              <div className="bg-[#F4F5F9] lg:h-[220px] lg:w-[350px] -mt-6 lg:-ml-[100px]">
                ...
                <input
                  type="email"
                  className="mt-3 lg:-ml-[60px] p-2 text-sm focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                ...
                />
                <button
                  class="inline-block text-sm px-4 py-[12px] lg:mt-0 bg-gradient-to-r from-[#0909E9] to-[#00D4FF] border rounded border-none text-white font-semibold"
      ...
      <div class="flex-1 p-2 font-bold font-larsseit text-[14px] hover:text-blue-600 hover:underline">Cookies</div>
              ...
              <p className="font-bold text-sm">
                Copyrights © 2024 Alanced Proudly Created by{" "}
                <a href="https://wiz91.com/" target="_blank">
                  {" "}
                  Wiz91 Technologies{" "}
                </a>
              </p>
            ...
            <div className="flex-1 flex justify-end p-4 pr-0 pt-1">
              <div class="flex sm:justify-center xl:justify-start md:justify-end">
                <a
                  ...
                  class="w-8 h-8 border-2 border-gray-400 rounded-full text-center py-1 text-gray-600 hover:text-white hover:bg-gradient-to-r from-[#0909E9] to-[#00D4FF] hover:border-[#6f7cf3]"
                >
                  <img src={linkedin} alt="" className="ml-2 mt-1" />
                </a>
                <a
                  href="https://www.facebook.com/"
                  class="w-8 h-8 border-2 border-gray-400 rounded-full text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-gradient-to-r from-[#0909E9] to-[#00D4FF] hover:border-[#6f7cf3]"
                >
