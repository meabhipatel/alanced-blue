        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-5 ">
            ...
            <div class="p-4 col-span-2">
              <div className="bg-[#F4F5F9] lg:h-[220px] lg:w-[350px] -mt-6 ">
                ...
                <div className="w-full flex items-center px-2 mt-5">
                  ...
                  />
                  <button
                    class="w-12 h-10 inline-block text-sm px-4 py-[12px] lg:mt-0 bg-gradient-to-r from-[#0909E9] to-[#00D4FF] border rounded border-none text-white font-semibold"
