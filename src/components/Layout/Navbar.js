...
const Navbar = () => {
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto mt-0">
    <div class="text-sm lg:flex-grow ml-[45px] -mt-5">
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0e mr-4 font-inter text-[16px] text-[#031136]">
        Find Talent
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 mr-4 font-inter text-[16px] text-[#031136]">
        Find Work
      </a>
      <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 mr-4 font-inter text-[16px] text-[#031136]">
        Why Alanced
