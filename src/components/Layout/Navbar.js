...
<div className='sticky z-50 top-0 bg-cover bg-top' style={{ backgroundImage: `url(${navback})`}}>
  ...
  {!isLoggedIn ? 
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto mt-0">
    <div class="text-sm lg:flex-grow lg:ml-[45px]">
      <Link to='/projects'><span href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 lg:mr-12 font-inter text-[16px] text-[#031136]">Find Work</span></Link>
      <Link to=''><span class="block mt-4 lg:inline-block lg:mt-0 lg:mr-12 font-inter text-[16px] text-[#031136]">My Jobs</span></Link>
    ...
    <div className='flex items-center p-2 bg-white rounded-lg shadow-md'>
        <div className='flex items-center mr-1'>
            ...
            <input className='w-40 lg:w-56 h-7 text-xs lg:text-sm rounded mr-1' placeholder='Search' />
        </div>
        <div className="border-l h-5 mx-5 border-gray-400"></div>
        <div className='mr-1'>
            <select id="countries" class="bg-gray-50 text-[#797979] text-xs font-inter font-normal rounded h-7 mr-1 cursor-pointer">
        ...
        <button className='rounded h-7 w-7 p-2 text-xs lg:text-sm font-semibold text-white bg-gradient-to-r from-[#00BF58] to-[#E3FF75]'>
            <img src={searchbtn} alt="Search Icon" className="" />
        </button>
    </div>
</section>
...
<div className="ml-4 relative">
    ...
    <span class="absolute top-0.5 right-0 block h-2.5 w-2.5 rounded-full bg-green-500 border-2 border-white"></span>
</div>
            ...
            {logindata.first_Name && logindata.first_Name[0].toUpperCase()}
                ...
                {dropdownVisible && (
                  ...
                  <div className="py-1">
                    ...
                    // <div className="absolute right-0 mt-5 w-48 rounded-md shadow-lg bg-white">
                    //     <div className="py-1">
                    //         <Link to='/freelancer/profile'><span className="block px-4 py-2 font-inter text-[16px] text-[#031136] hover:bg-gray-100">My Profile</span></Link>
                    //         <Link to='/freelancer/editprofile'><span className="block px-4 py-2 font-inter text-[16px] text-[#031136] hover:bg-gray-100">Edit Profile</span></Link>
                    //         <Link to='/'><span href="#" className="block px-4 py-2 font-inter text-[16px] text-[#031136] hover:bg-gray-100" onClick={handleLogout}>Logout</span></Link>
                    //     </div>
                    // </div>
                )}
            </div>
