      ...
      <div className=' mt-12'>
        <div className=' flex flex-row'>
          ...
          <div className='basis-9/12 mt-5'>
            <h1 className=' font-jost font-semibold text-left text-[22px]'>Create your profile (it’s free)</h1>
            <p className=' font-jost text-[15px] mt-3 opacity-50 text-left mb-5'>Include only your professional skills and experience that are relevant to the job you're targeting. This is especially helpful if your skills and work history differ from your current career goals because it enables you to showcase the related expertise that hiring managers are looking for.</p>
          </div>
        </div>
        <div className=' flex flex-row mt-5'>
          <div className='basis-3/12'><img src={earn} alt="" className='h-32 ml-1 mx-auto' /></div>
          <div className='basis-9/12 mt-5'>
            <h1 className=' font-jost font-semibold text-left text-[22px]'>Foster financial growth</h1>
            <p className=' font-jost text-[15px] mt-3 opacity-50 text-left mb-5'>Foster financial growth" refers to the deliberate actions or strategies aimed at nurturing and encouraging the expansion of one's financial resources, investments, or wealth. This can involve activities such as saving, investing, or pursuing opportunities to increase income.</p>
          </div>
        </div>
        <div className=' flex flex-row mt-5'>
          <div className='basis-3/12'><img src={pay} alt="" className='h-32 ml-1 mx-auto' /></div>
          <div className='basis-9/12 mt-5'>
            <h1 className=' font-jost font-semibold text-left text-[22px]'>Safe and Reliable payment method.</h1>
            <p className=' font-jost text-[15px] mt-3 opacity-50 text-left mb-5'>A secure and reliable payment method refers to a financial transaction process that safeguards sensitive data, such as personal and financial information, while ensuring that payments are processed accurately and in a timely manner.</p>
          </div>
        </div>
      </div>
        <div className=' flex flex-row border border-gray-200 rounded mt-12'>
          <div className=' basis-6/12 ml-16 border-r border-gray-200'>
            ...
            <div className=' text-left mb-8'> <Link to='/view-all/freelancer' onClick={() => window.scroll(0, 0)}><span class="inline-block text-[16px] px-5 py-[10px] mt-8 bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-2 text-base font-semibold ">Talents</span></Link></div>
          </div>
          ...
          <div class="w-32  mt-2 relative">
            ...
            <div className=' text-left mb-8'> <Link to='/projects' onClick={() => window.scroll(0, 0)}><span class="inline-block text-[16px] px-7 py-[10px] mt-8 bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-2 font-semibold text-base">Works</span></Link></div>
          </div>
        </div>
