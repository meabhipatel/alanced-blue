      ...
      <div className=' mt-12'>
        ...
        <div className=' flex flex-row border border-gray-200 rounded mt-12'>
          ...
          <div class="w-32  mt-2 relative">
            ...
            <div className=' text-left mb-8'> <Link to='/projects' onClick={() => window.scroll(0, 0)}><span class="inline-block text-[16px] px-7 py-[10px] mt-8 bg-gradient-to-r from-[#0909E9] to-[#00D4FF] border rounded border-none text-white mr-2 font-semibold text-base">Works</span></Link></div>
          </div>
        </div>
