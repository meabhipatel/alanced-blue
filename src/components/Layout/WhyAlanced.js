      ...
      <div className="container-sm px-32 mt-10">
        <div className=" flex flex-row border border-gray-200 rounded">
          <div className=" basis-8/12">
            <h1 className="ml-8 text-left font-jost text-[26px] mt-6 font-semibold text-blue-600">
              Take part in the global job market platform.
            </h1>
              ...
              <Link to="/projects">
                <div class="p-0.5 mt-5 rounded bg-gradient-to-b from-[#0909E9] to-[#00D4FF] ml-5">
                  <button class="px-2 py-1 bg-[#f8faf9] rounded">
                    <p class="bg-gradient-to-r from-primary to-danger bg-clip-text text-transparent font-bold text-sm py-[4px] px-[8px]">
                      Find Work
                    </p>
                  </button>
                </div>
        ...
        <div className=" mt-12">
          <div className=" flex flex-row">
            ...
            <div className="basis-9/12 mt-5">
              <h1 className=" font-jost font-semibold text-left text-[22px]">
                Create your profile (it’s free)
              </h1>
              <p className=" font-jost text-[15px] mt-3 opacity-50 text-left mb-5">
                Include only your professional skills and experience that are
                relevant to the job you're targeting. This is especially helpful
                if your skills and work history differ from your current career
                goals because it enables you to showcase the related expertise
          ...
          <div className=" flex flex-row mt-5">
            ...
            <div className="basis-9/12 mt-5">
              ...
              <p className=" font-jost text-[15px] mt-3 opacity-50 text-left mb-5">
                Foster financial growth" refers to the deliberate actions or
                strategies aimed at nurturing and encouraging the expansion of
                one's financial resources, investments, or wealth. This can
                involve activities such as saving, investing, or pursuing
          ...
          <div className=" flex flex-row mt-5">
            ...
            <div className="basis-9/12 mt-5">
              ...
              <p className=" font-jost text-[15px] mt-3 opacity-50 text-left mb-5">
                A secure and reliable payment method refers to a financial
                transaction process that safeguards sensitive data, such as
                personal and financial information, while ensuring that payments
                are processed accurately and in a timely manner.
              </p>
            </div>
          </div>
        </div>
        <div className=" flex flex-row border border-gray-200 rounded mt-12">
          <div className=" basis-6/12 ml-16 border-r border-gray-200">
            <h1 className="font-jost text-[24px] mt-8 text-left font-semibold">
            ...
            <h1 className="font-jost text-[18px] mt-3 opacity-70 text-left">
              Discover the perfect talent match in our Talent <br />
              Marketplace.
            </h1>
            <p className="font-jost text-[15px] mt-4 opacity-70 text-left">
              Publish your job listing on the global job market and <br />{" "}
              anticipate a wave of proposals from skilled
              <br /> individuals spanning the globe
            </p>
            <p className="font-jost text-[15px] mt-4 opacity-70 text-left">
              Our cutting-edge algorithms assist in identifying <br /> top
              candidates tailored to your needs.You have <br /> the opportunity
              to thoroughly review profiles,
          ...
          <div className=" basis-6/12 ml-16">
            ...
            <p className="font-jost text-[15px] mt-4 opacity-70 text-left">
              ...
              <br /> professional looking to expand your horizons or a<br />{" "}
              fresh talent eager to make your mark.
            </p>
            <div className=" text-left mb-8">
              {" "}
        ...
        <div className=" flex flex-row mt-12 mb-5">
          <div className=" basis-9/12 ml-4">
            <h1 className="text-left font-jost text-[26px] mt-6 font-semibold">
            ...
            <p className="font-jost  text-[15px] mt-4 opacity-[70%] text-left">
              Our availability is unwavering, ensuring your access to our
              services around the clock, 24 hours a day, 7 days a week. Whenever
              you need assistance, support, or have inquiries, we're here to
              respond promptly, no matter the time or day. Our commitment to
              round-the-clock availability means you can rely on us for
              assistance, guidance, and peace of mind at any hour, making your
