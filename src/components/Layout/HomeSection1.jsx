...
const HomeSection1 = () => {
  return (
    <div>
      {/* ---> Trusted by companies comented as of now */}
    ...
    <img src={zoom} alt="" />
      ...
      <div class="flex flex-col md:flex-row gap-4 px-4 lg:px-32 md:mt-6">
        <div class="w-full md:w-[50%] relative p-10">
        ...
        <div class="w-full md:w-[50%] p-4 text-left">
