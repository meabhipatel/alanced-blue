...
const Background = () => {
  return (
    ...
    <div className="h-screen bg-center bg-cover" style={{ backgroundImage: `url(${background})` }}>
        ...
        <div className='text-left pt-36 ml-[11.5vw] -mt-[6.6vh]'>
          ...
          <Link to='/sign-up'><span class="inline-block text-sm px-4 py-[10px] lg:mt-0 bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-2 font-semibold">Get Started</span></Link>
        </div>
    </div>
    </>
  )
