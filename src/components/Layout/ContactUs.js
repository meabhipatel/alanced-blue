...
const onChange = e =>{
  ...
  <h1 className="font-inter text-md  text-[#031136] text-left font-semibold pt-4"><i class="bi bi-telephone-fill text-blue-600 mr-1"></i> Phone: <span className='font-normal opacity-40'>+91 907-498-7922</span></h1>
  <h1 className="font-inter text-md  text-[#031136] text-left font-semibold pt-1"><i class="bi bi-envelope-at text-blue-600 mr-1"></i> Email: <span className='font-normal opacity-40'>info@wiz91.com</span></h1>
  <h1 className="font-inter text-lg  text-[#031136] text-left font-semibold pt-5">Our Location:</h1>
  <h1 className="font-inter text-md text-[#031136] text-left font-normal pt-4"><i class="bi bi-geo-alt-fill text-blue-600 mr-1"></i><span className='opacity-40'> Wiz91 Technologies, 202, Krishna Classic, AB Rd, above AXIS Bank, Phadnis Colony, Indore, Madhya Pradesh 452001</span>
  ...
  <h1 className="font-inter text-md  text-[#031136] text-left font-semibold pt-4"><i class="bi bi-whatsapp text-blue-600 mr-1"></i> WhatsApp: <span className='font-normal opacity-40'>+91 860-269-4727</span></h1>
  </h1>
  </div>
</div>
