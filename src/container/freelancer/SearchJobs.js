            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">Less than $100(23222)</span>
            </label>
        </div>
    </div>
    <div className='flex flex-row my-3 px-2'>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">$100 to $500   (23222)</span>
            </label>
        </div>
    </div>
    <div className='flex flex-row my-3 px-2'>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">$500 - $1K   (7076)</span>
            </label>
        </div>
    </div>
    <div className='flex flex-row my-3 px-2'>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">$1K - $5K   (8376)</span>
            </label>
        </div>
    </div>
    <div className='flex flex-row my-3 px-2'>
        <div className='basis-8/12'>
            ...
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Number of proposals</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    <div className='flex flex-row mt-4'>
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(2945)</div>
            ...
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Client Info</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    <div className='flex flex-row mt-4'>
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(117654)</div>
            ...
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Client History</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    <div className='flex flex-row mt-4'>
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(1945)</div>
    </div>
            <div className='flex flex-row mt-4'>
        <div className='basis-8/12'>
            <label class="flex items-center font-inter relative cursor-pointer">
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(945)</div>
            ...
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Client Location</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    ...
    <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
    <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Client Time Zones</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    ...
    <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Project Length</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
    <div className='flex flex-row mt-4'>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">Less than one month</span>
            </label>
        </div>
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(15765)</div>
    </div>
            <div className='flex flex-row mt-4'>
        <div className='basis-8/12'>
            <label class="flex items-center font-inter relative cursor-pointer">
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(16543)</div>
    </div>
            <div className='flex flex-row mt-4'>
        <div className='basis-8/12'>
            <label class="flex items-center font-inter relative cursor-pointer">
        ...
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(11945)</div>
    </div>
            <div className='flex flex-row mt-4'>
        <div className='basis-8/12'>
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">More than 6 months</span>
            </label>
        </div>
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(7745)</div>
    </div>
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Hours Per Week</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">Less than 30 hrs/week</span>
            </label>
        </div>
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(1945)</div>
    </div>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">More than 30 hrs/week</span>
            </label>
        </div>
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(2945)</div>
    </div>
            <div class="flex-1 border-t-2 border-gray-200 opacity-30 mt-8 mr-6"></div>
            <div className="flex items-center justify-between">
  <h1 className='font-cardo text-[20px] text-[#031136] py-4'>Connects Needed</h1>
    <div className="flex items-center space-x-2">
    <i class="bi bi-chevron-down text-[#031136] pr-11 text-sm"></i>
    </div>
    </div>
            ...
            <label class="flex items-center font-inter relative cursor-pointer">
                ...
                <div class="checkbox-border-gradient bg-transparent mr-3 w-5 h-5 rounded flex items-center justify-center">
                    ...
                    <span class="checkmark hidden"><i class="bi bi-check-lg pr-2 pt-2"></i></span>
                     ...
                     <span class="normal-checkbox mr-3 border border-gray-300 w-5 h-5 inline-block rounded"></span>
                <span class="font-normal text-[#797979]">4 or less connects</span>
            </label>
        </div>
        <div className='basis-4/12 font-inter text-base font-normal text-[#797979] text-left'>(15765)</div>
    </div>
