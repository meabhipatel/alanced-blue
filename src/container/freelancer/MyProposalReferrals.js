...
const MyProposalReferrals = () => {
  ...
  return (
    ...
    <div className='border border-[#E7E8F2] py-12 mt-8'>
        ...
        <h1 className=' font-inter font-semibold text-base text-center mt-3'>You haven’t referred anyone yet</h1>
        <p className=' font-inter font-normal text-base text-center opacity-[50%] mt-2'>When declining an invitation, you can make a referral to help other freelancers</p>
        <p className=' font-inter font-normal text-base text-center opacity-[50%] mt-1'>succeed and help clients fill their job</p>
        <h1 className=' font-cardo font-normal text-lg text-center mt-2'>Learn more about referring freelancers</h1>
    </div>
    </div>
    <HomeSection4/>
    <Footer/>
