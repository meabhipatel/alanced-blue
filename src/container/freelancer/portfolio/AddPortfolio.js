        ...
        <div className=' flex flex-row'>
            ...
            <div className=' basis-9/12'>
                <div className='border border-[#E7E8F2] py-8 px-8 rounded-xl'>
                    ...
                    <input type="text" class=" mt-3 bg-blue-50 border border-gray-300 dark:text-gray-400 placeholder-gray-700 dark:placeholder-blue-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 p-2.5 dark:bg-blue-600 dark:border-blue-500" placeholder="Enter Project Title"></input>
                    ...
                    <input type="date" class=" mt-3 bg-blue-50 border border-gray-300 dark:text-gray-400 placeholder-gray-700 dark:placeholder-blue-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-96 p-2.5 dark:bg-blue-600 dark:border-blue-500" placeholder=""></input>
                    <div className=' flex flex-row mt-16'>
                        ...
                        <div className=' basis-6/12'>
                        <span class="inline-block text-sm px-6 py-[10px] mt-4 lg:mt-0 bg-gradient-to-r from-[#0909E9] to-[#00D4FF] border rounded-full border-none text-white mr-2 font-bold ml-[8rem]">Go To Select Templete</span>
                        </div>
                    </div>
                </div>
            </div>
