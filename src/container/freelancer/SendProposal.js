    ...
    <div className=' container-sm px-36'>
        ...
        <h1 className=' text-2xl font-cardo font-semibold text-left'>Job Details</h1>
            ...
            {JSON.parse(projectData.project.skills_required.replace(/'/g,'"')).map((skill,index)=>(
                <div className="mr-3 focus:outline-none  bg-[#b4d3c3] hover:bg-[#c1e2d1] inline-block rounded-full  text-green-800 px-5 py-[3px] text-sm font-semibold dark:bg-[#b4d3c3] dark:hover:bg-[#dffdee] bg-opacity-[60%]">
