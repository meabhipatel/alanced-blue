...
const FreelancerSelfProfile = () => {
  ...
  return (
   ...
   <div class="flex flex-col md:flex-row">
    <div class="md:w-[30%] p-4 bg-[#FFFFFF] py-8 border border-gray-100 border-opacity-50 mb-4 md:mb-0">
    ...
    <div class="md:w-[70%] border border-gray-100 border-opacity-50 flex flex-col md:flex-row">
...
<div class="flex flex-col md:flex-row">
    <div class="w-full md:w-[30%] py-4 pl-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left mb-4 md:mb-0">
    ...
    <div class="w-full md:w-[70%] py-4 px-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left">
    ...
    <div class="flex">
    <div class="w-[30%] py-4 pl-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left">
    ...
    <div class="w-[70%] py-4 px-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left">
   ...
   <h1 className="font-cardo text-[18px] text-[#031136] font-normal py-2 cursor-pointer">See More</h1>
    ...
    <div class="flex">
    <div class="w-[30%] py-4 pl-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left"></div>
    <div class="w-[70%] py-4 px-8 bg-[#FFFFFF] border border-gray-100 border-opacity-50 text-left">
    <div className="flex justify-between items-center">
