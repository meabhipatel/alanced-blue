...
const OtherExperiencePopup = ({ closeOtherExp }) => {
  return (
    ...
    <div className='mt-10'>
            ...
            <input type="text" className='border my-2 py-1.5 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600'/>
            <h1 className="font-cardo text-[20px] text-[#031136] font-normal text-left mt-5">Description</h1>
            <textarea name="" id="" cols="30" rows="5" className='border my-2 mb-6 py-1.5 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600'></textarea>
            ...
            <div class="p-0.5 inline-block rounded bg-gradient-to-b from-[#00BF58] to-[#E3FF75]" onClick={closeOtherExp}>
