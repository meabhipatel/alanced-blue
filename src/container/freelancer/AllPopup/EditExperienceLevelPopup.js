...
const EditExperienceLevelPopup = ({ closeExperienceLevel }) => {
  ...
  return (
    ...
    <div className='mt-10'>
            {/* <input type="text" className='border mt-2 mb-6 py-1.5 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600' value={experiencelevel} onChange={e => setexperiencelevel(e.target.value)}/> */}
            <select className="border mt-2 mb-6 py-2 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600 bg-white opacity-50" value={experiencelevel} onChange={e => setexperiencelevel(e.target.value)}>
            ...
            <div class="p-0.5 inline-block rounded bg-gradient-to-b from-[#00BF58] to-[#E3FF75]" onClick={closeExperienceLevel}>
