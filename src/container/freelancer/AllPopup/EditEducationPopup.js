...
const EditEducationPopup = ({ qualification, university, startdate ,enddate,stream,closeEditEducation }) => {
  ...
  return (
    ...
    <div className="flex justify-between items-center">
        <h1 className="font-cardo text-[26px] text-[#031136] font-normal">Edit Education</h1>
        <button onClick={closeEditEducation} className="text-gray-500 hover:text-gray-700">
            <i class="bi bi-x-lg"></i>
        </button>
    </div>
    <div className='mt-10'>
            <h1 className="font-cardo text-[20px] text-[#031136] font-normal text-left">School/ University</h1>
            <input type="text" className='border mt-2 mb-6 py-1.5 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600' defaultValue={university}/>
