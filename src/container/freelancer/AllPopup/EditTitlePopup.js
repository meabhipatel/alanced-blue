...
const EditTitlePopup = ({ closeEditTitle }) => {
  return (
    ...
    <div className="fixed z-10 inset-0 overflow-y-auto mt-10">
                    ...
                    <div className='mt-10'>
                            <h1 className="font-cardo text-[20px] text-[#031136] font-normal text-left">Your Title</h1>
                            <p className="font-inter text-[14px] text-[#031136] font-normal pt-2 text-left opacity-50">Enter a single sentence description of your professional skills/experience (e.g. Expert Web Designer with Ajax experience) </p>
                            <input type="text" className='border my-5 py-1.5 px-2 rounded-md w-full focus:border-lime-400 focus:outline-none focus:ring-1 focus:ring-lime-600' placeholder='Python Developer'/>
