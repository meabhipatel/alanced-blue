    ...
    <img src={zoom} alt="" />
        ...
        <div className='flex flex-row space-x-8 mt-10'>
            ...
            <h1 className=' font-cardo text-[30px] text-left mt-2'>Work</h1>
                ...
                <div className='text-left mt-3'><Link to='/jobs'  onClick={() => window.scroll(0, 0)}><span class="inline-block text-sm px-4 py-[10px] mt-4 lg:mt-0 bg-gradient-to-r bg-[#addac2] border rounded border-none text-white mr-2 font-semibold">View Features</span></Link></div>
            </div>
