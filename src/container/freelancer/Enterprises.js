  ...
  return (
    ...
    <div className=' container-sm px-32 mt-10'>
        <div className=' flex flex-row border border-gray-200 rounded-lg border-opacity-[50%] bg-[#dcf7ea]'>
            <div className=' basis-6/12 mt-8 text-left'>
                <h1 className=' ml-8 font-jost  font-bold text-[22px] text-lime-700'>Alanced</h1>
                ...
                <h1 className=' ml-8 font-jost text-[35px] mt-5 font-semibold text-lime-600'>Your Trusted </h1>
                <h1 className=' ml-8 font-jost text-[28px] font-semibold text-lime-600'>Partner For Design And</h1>
                <h1 className=' ml-8 font-jost text-[28px] font-semibold text-lime-600'>Web Development.</h1>
                ...
                <Link to='/sign-up' onClick={() => window.scroll(0, 0)}><span class="inline-block text-sm px-4 py-[10px] mt-8 bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-2 font-semibold ml-8">Let's Connect</span></Link>
            </div>
    ...
    <img src={zoom} alt="" />
        ...
        <div className='flex flex-row space-x-8 mt-10'>
            <div className=' basis-3/12 border border-green-200 rounded-lg border-opacity-[50%] p-6 shadow-md bg-[#daf6f8]'>
            ...
            <div className=' basis-3/12 border border-green-200 rounded-lg border-opacity-[50%] p-6 shadow-md bg-[#e6ebfc]'>
            ...
            <div className=' basis-3/12 border border-green-200 rounded-lg border-opacity-[50%] p-6 shadow-md bg-[#f5f5f4]'>
        ...
        <div className=' flex flex-row mt-16 border border-gray-200 rounded-lg border-opacity-[50%]'>
            ...
            <div className=' basis-6/12 text-left pl-12'>
                ...
                <div className=' flex flex-row mt-8'>
                    <div className=' basis-1/12'><i class="bi bi-check-lg text-green-600 text-[25px]"></i></div>
        ...
        <div className=' flex flex-row mt-16 border border-gray-200 rounded-lg border-opacity-[50%]'>
            ...
            <div className=' text-left'> <Link to='/contact-us' onClick={() => window.scroll(0, 0)}><span class="inline-block text-sm px-4 py-[10px] mt-8 bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-2 font-semibold ml-8">Contact Us</span></Link></div>
            </div>
