        ...
        <div className=' w-full mt-10 bg-[#d9f3e6] h-[60px] rounded-xl'>
            ...
            <h1 className=' text-2xl font-cardo font-semibold text-left'>Job Details</h1>
                <div className=' flex flex-row mt-6'>
                    ...
                    <div className=' flex flex-row'>
                    <div className=' basis-5/12 mt-5'><div  class="focus:outline-none  bg-[#b4d3c3] hover:bg-[#c1e2d1]  rounded-xl text-sm font-semibold text-blue-800 py-[3px] dark:bg-[#dffdee] dark:hover:bg-[#dffdee]  bg-opacity-[60%]">{projectdata.project.category}</div></div>
                ...
                <p className='text-base font-medium font-inter text-left mt-5 opacity-70'>{addedbid.bid_amount}</p>
                <hr className=' mt-5' />
