        ...
        <div className=' w-full mt-10 bg-[#d9f3e6] h-[60px] rounded-xl'>
            ...
            <h1 className=' text-2xl font-cardo font-semibold text-left'>Job Details</h1>
                <div className=' flex flex-row mt-6'>
                    ...
                    <div className=' flex flex-row'>
                    <div className=' basis-4/12 mt-5'><div  class="focus:outline-none  bg-[#b4d3c3] hover:bg-[#c1e2d1]  rounded-xl text-sm font-semibold text-blue-800 py-[3px] dark:bg-[#dffdee] dark:hover:bg-[#dffdee]  w-[90%] bg-opacity-[60%]">{findbid.project.category}</div></div>
                    <div className=' basis-4/12 mt-5 ml-2'><p className=' text-sm font-medium font-inter text-left opacity-[50%]'>Posted {timeAgo(findbid.project.created_at)}</p></div>
                    </div>
                    ...
                    <div className=' basis-3/12 border-l border-[#E7E8F2]'>
                        <div className=' flex flex-row ml-4'>
                            ...
                            <div className=' basis-6/12'>
                                <p className=' text-[14px] font-normal text-left'>{findbid.project.Project_experience_level.replace(/_/g, ' ')}</p>
            ...
            {findbid.description}
                ...
                <div className=' basis-3/12'>
                    ...
                    <div className='mt-5 ml-7'>
                        ...
                        <p className='text-[15px] font-inter font-normal opacity-75 mt-2 text-left'>{findbid.project.project_owner_Name}</p>
                    ...
                    <div className='mt-5 ml-7'>
                        ...
                        <p className='text-[15px] font-inter font-normal opacity-75 mt-2 text-left'>{findbid.project.project_owner_location}</p>
                        {/* <p className='text-[15px] font-inter font-normal opacity-75  text-left'>kathmandu 04:42 PM</p> */}
                    </div>
                    <div className='mt-5 ml-7'>
                        ...
                        <p className='text-[12px] font-inter font-normal opacity-75 mt-2 text-left'>Member since {findbid.project.project_owner_date_of_creation}</p>
                    </div>
                </div>
            </div>
        </div>
