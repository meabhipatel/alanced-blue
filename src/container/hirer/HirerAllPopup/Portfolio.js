...
const Portfolio = ({closePortfolio}) => {
  return (
    <>
    <div className="fixed z-10 inset-0 overflow-y-auto mt-24">
                    ...
                    <div className="flex justify-between items-center">
                        <h1 className="font-cardo text-[26px] text-[#031136] font-normal text-wrap">project_title</h1>
            ...
            <p className="font-inter text-sm text-[#031136] font-normal opacity-50 text-left py-4">project_description</p>
