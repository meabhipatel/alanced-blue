    ...
    return(
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto mt-10">
                    ...
                    <option value="Bhopal">Bhopal</option> */}
                            ...
                            <Link to='' onClick={handleSave}><span class="inline-block text-sm px-6 py-[10px] bg-gradient-to-r from-[#00BF58] to-[#E3FF75] border rounded border-none text-white mr-3 font-semibold">Save</span></Link>
