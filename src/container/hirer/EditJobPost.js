      ...
      <div className="mt-2 mx-[9%]">
        ...
        <div className="my-2 bg-[#FFFFFF] border border-gray-200 border-opacity-30 text-left">
          <div className="border-b border-gray-200 border-opacity-30 py-5 px-8 flex justify-between items-center">
            <h1 className="font-inter text-xl text-[#031136] text-left font-semibold">
              {project.title}
            </h1>
            <div
          ...
          <div className="border-b border-gray-200 border-opacity-30 py-5 px-8 flex justify-between items-center">
            ...
            {isJobDescOpen && (
              <EditJobDescPopup closeJobDesc={closeJobDesc} project={project} />
            )}
          </div>
          <div className="border-b border-gray-200 border-opacity-30 py-5 px-8">
            <div className="flex justify-between items-center">
              <div className="flex flex-col">
                <h1 className="font-inter text-lg text-[#031136] font-semibold text-left">
                  category
                </h1>
              ...
              <div
                ...
                onClick={() => openJobCategory(project)}
              >
                <img src={edit} alt="more" />
              </div>
              {isJobCategoryOpen && (
                <EditCategoryPopup
                  closeJobCategory={closeJobCategory}
                  project={project}
                />
              )}
            </div>
            <div className="flex justify-between items-center mt-5">
              ...
              <div
                className="p-1 w-6 h-6 bg-white rounded-full border border-gray-200 cursor-pointer"
                onClick={() => openJobSkills(project)}
              >
                <img src={edit} alt="more" />
              </div>
              {isJobSkillsOpen && (
                <EditJobSkillsPopup
                  closeJobSkills={closeJobSkills}
                  project={project}
                />
              )}
            </div>
            <div className="flex justify-between items-center mt-5">
              <div className="flex flex-col">
                <h1 className="font-inter text-lg text-[#031136] font-semibold text-left pb-2">
                  Scope
                </h1>
                <h1 className="font-inter text-md opacity-50 text-[#031136] font-normal text-left py-1">
              ...
              <div
                className="p-1 w-6 h-6 bg-white rounded-full border border-gray-200 cursor-pointer"
                onClick={() => openJobScope(project)}
              >
                <img src={edit} alt="more" />
              </div>
              {isJobScopeOpen && (
                <EditJobScopePopup
                  closeJobScope={closeJobScope}
                  project={project}
                />
              )}
            </div>
            <div className="flex justify-between items-center mt-5">
              <div className="flex flex-col">
                ...
                <h1 className="font-inter text-md opacity-50 text-[#031136] font-normal text-left py-1">
                  {project.Project_Rate} Rate
                </h1>
              </div>
              <div
                className="p-1 w-6 h-6 bg-white rounded-full border border-gray-200 cursor-pointer"
                onClick={() => openJobBudget(project)}
              >
                <img src={edit} alt="more" />
              </div>
              {isJobBudgetOpen && (
                <EditJobBudget
                  closeJobBudget={closeJobBudget}
                  project={project}
                />
              )}
            </div>
