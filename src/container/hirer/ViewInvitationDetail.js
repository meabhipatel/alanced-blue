...
: findinvite.freelancer_description.slice(0, 300);
  ...
  return (
    ...
    <div className='container-sm px-36'>
            <h1 className='font-inter text-2xl text-left mt-5'>View Invitation Details</h1>
                <div className=' my-8  border border-[#E7E8F2] py-8 px-8 rounded-lg'>
                   <h1 className='text-3xl font-cardo font-semibold text-left'>Invite Details</h1>
                   <div className="grid grid-cols-3 gap-4">
  <div>
    <p className="text-xl font-medium font-cardo text-left mt-5">
      Hiring Budget : <span className="opacity-70">${findinvite && findinvite.hiring_budget ? findinvite.hiring_budget : 0}</span></p>
 </div>
  <div>
    <p className="text-xl font-medium font-cardo text-left mt-5">
      Budget Type : <span className="opacity-70">{findinvite && findinvite.hiring_budget_type ? findinvite.hiring_budget_type: ""}</span>
    </p>
  </div>
  <div>
    <p className="text-xl font-medium font-cardo text-left mt-5">
...
<div>
    <p className="text-xl font-medium font-cardo text-left mt-4">
      Invite Status : <span className="opacity-70 inline-block">{findinvite && findinvite.freelancer_accepted ? (
                ...
                <hr className='my-5' />
            <h1 className=' text-2xl font-cardo font-semibold text-left'>Freelancer Details</h1>
                    ...
                    <div className=' basis-3/12 border-l border-[#E7E8F2]'>
                        ...
                        <div className=' flex flex-row ml-4 mt-4'>
                            ...
                            <div className=' basis-9/12'>
                                <p className=' text-[14px] font-normal text-left'>${findinvite && findinvite.freelancer_hourly_rate ? findinvite.freelancer_hourly_rate : 0}</p>
                                <p className=' text-[12px] font-normal text-left opacity-50'>Hourly Rate</p>
                            </div>
                        </div>
                        <div className=' flex flex-row ml-4 mt-4'>
