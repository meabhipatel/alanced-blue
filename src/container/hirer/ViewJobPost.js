...
const ViewJobPost = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://www.api.alanced.com/freelance/View/project-invitations-count/${id}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
          ...
          <div class="flex flex-col md:flex-row">
            <div class="w-full md:w-[70%] bg-[#FFFFFF] border border-gray-200 border-opacity-30 text-left">
              <div className="border-b border-gray-200 border-opacity-30 py-6 px-8">
                <p className="font-inter text-blue-700 text-[16px] font-medium">
                  {project.category}
                </p>
                <p className="font-inter text-[#031136] opacity-50 text-sm font-medium py-1">
              ...
              <div className="border-b border-gray-200 border-opacity-30 py-6 px-8">
                <p className="font-inter text-[#031136] text-md font-medium opacity-50">
                  {project.description}
                </p>
              </div>
              <div className="border-b border-gray-200 border-opacity-30 py-6 px-8">
              ...
              <div className="border-b border-gray-200 border-opacity-30 py-6 px-8 flex items-center">
                <div className="flex-1">
                  <p className="font-inter text-[#031136] text-lg font-medium">
              ...
              <div className="border-b border-gray-200 border-opacity-30 py-6 px-8">
                <p className="font-inter text-[#031136] text-lg font-medium py-4">
            ...
            <div class="w-full md:w-[30%] bg-[#FFFFFF] border border-gray-200 border-opacity-30 text-left">
              ...
              <div className="border-b border-gray-200 border-opacity-30 py-4 px-8">
                ...
                <p className="font-inter text-[#031136] opacity-50 text-md font-medium py-2 mr-2 inline-block">
                  Payment method not verified
                </p>
                <i class="bi bi-question-circle-fill text-blue-700 inline-block"></i>
                <p className="font-inter text-[#031136] text-md font-medium py-2">
                  {project.project_owner_name}
                </p>
                <p className="font-inter text-[#031136] text-md font-medium">
                  {project.project_owner_address}
                </p>
                <p className="font-inter text-[#031136] opacity-50 text-md font-medium">
                  {getCurrentTime()}
                </p>
                <p className="font-inter text-[#031136] text-md font-medium py-2">
                  {viewhirerProjectcount} job posted
                </p>
                <p className="font-inter text-[#031136] text-sm font-medium opacity-50">
